...
public class VerifySignedStringWithPublicKey extends CustomJavaAction<java.lang.Boolean>
{
	...
	private final java.lang.String SignedString;

	public VerifySignedStringWithPublicKey(
		IContext context,
		java.lang.String _cerFileName,
		java.lang.String _originalString,
		java.lang.String _signedString
	)
	{
		super(context);
		this.CerFileName = _cerFileName;
		this.OriginalString = _originalString;
		this.SignedString = _signedString;
	}
